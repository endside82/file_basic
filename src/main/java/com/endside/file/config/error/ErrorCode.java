...
public enum ErrorCode {
    ...
    // FILE (1301XX)
    INVALID_CATEGORY(400,130101,"INVALID_CATEGORY"),                           // Category 지정이 잘못 되어 있음
    INVALID_FILE_NAME(400,130102,"INVALID_FILE_NAME"),                         // 파일 이름이 없거나 올바르지 않음
    FILE_NOT_ATTACHED(400,130103,"FILE_NOT_ATTACHED"),                         // 파일 업로드시 파일이 첨부되어 있지 않음
    INVALID_REQUEST_FILE_PATH(400,130104,"INVALID_REQUEST_FILE_PATH"),         // 잘못된 파일 경로
    RESOURCE_NOT_PUBLIC(400,130105,"RESOURCE_NOT_PUBLIC"),                     // 공개된 경로가 아님 (not yet)
    FAILED_GET_INFO(404,130106,"FAILED_GET_INFO"),                             // 화이트 리스트 정보 추출 실패 (not yet)
    FILE_IO_EXCEPTION(401,130107,"FILE_IO_EXCEPTION"),                         // file io exception
    // AWS S3(2002XX)
    ...
    BATCH_SIZE_EXCEEDED(400,130108,"BATCH_SIZE_EXCEEDED"),                     // 배치 요청 최대 건수 초과
    ;
